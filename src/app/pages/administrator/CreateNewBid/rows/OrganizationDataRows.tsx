...
interface OrganizationDataRowsProps {
  formik: ReturnType<typeof useFormik>
}

export const OrganizationDataRows: React.FC<OrganizationDataRowsProps> = ({formik}) => {
  return (
    <>
      ...
      <div className='fv-row mb-8' key={initialValues.paymentMethod}>
        <label className='form-label fs-6 fw-bolder text-dark'>{initialValues.paymentMethod}</label>
        <input
      ...
      <div className='fv-row mb-8' key={initialValues.deliveryDate}>
        <label className='form-label fs-6 fw-bolder text-dark'>{initialValues.deliveryDate}</label>
        <input
      ...
      <div className='fv-row mb-8' key={initialValues.year}>
        ...
        <input
          ...
          className={clsx(
            ...
            {
              'is-valid': formik.touched[initialValues.year] && !formik.errors[initialValues.year],
            }
          )}
          type='text'
        />
      ...
      <div className='fv-row mb-8' key={initialValues.offerDescription}>
        ...
        <input
          ...
          className={clsx(
            ...
            {
              'is-invalid':
                formik.touched['offerDescription'] && formik.errors[initialValues.offerDescription],
            },
            {
              'is-valid':
      ...
      <div className='fv-row mb-8' key={initialValues.supervisor}>
        ...
        <input
          ...
          className={clsx(
            'form-control bg-transparent',
            {
              'is-invalid': formik.touched['supervisor'] && formik.errors[initialValues.supervisor],
            },
            {
              'is-valid':
